...
if __name__ == "__main__":
    ...
    results = parse("https://divoroom.store/catalog", headless=True)

    #results = parse("http://divoroom.store/catalog/tproduct/661904054722-brelki-korovki-vse-rastsvetki", headless=True)
    
    if results:
        with open('products.csv', 'w', encoding='utf-8-sig', newline='') as f:
            fieldnames = ['product_id', 'title', 'description', 'price', 'url', 'image']
